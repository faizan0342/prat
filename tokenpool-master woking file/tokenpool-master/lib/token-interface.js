...
console.log("What is COLLECT_TOKEN_DATA_PERIOD")
...
//minerEthAddress
  ...
  /*
    ...
    */
    ...
    async transferMinimumTokensToPayoutWallet()
    {
      ...
      {
        minPayoutWalletBalance = 10*10; //real value 1000*100 , we change to 10*10
      }
      ...
      var self = this;
      console.log("This is something related to transferMinimumTokensToPayoutWallet which is set to 5 minutes in token interface")
    ...
    async getTokenBalanceOf(address)
    {
      ...
      console.log("This is in token interface related to walletBalance",walletBalance)
  ...
  async queueTokenTransfersForBalances()
  {
    ...
    console.log("Yeh function chalta hai jb transfer hota hai ok")
    var self = this ;
  ...
  var minerList =  await this.getMinerList()
    ...
    for(i in minerList) //reward each miner
    {
      ...
      console.log("minerAddess ===========>", minerAddress)
      ...
      if(typeof minerData.tokensAwarded == 'undefined') minerData.tokensAwarded = 0;
       ...
       if(typeof num_tokens_owed != 'undefined' && num_tokens_owed > min_balance_for_transfer)
       {
         ...
         console.log("yeh token interface se hai Yaha yeh define krha hai k transfer kisko ho rha hai")
  ...
  getTokenContract()
  {
   ...
   async requestCurrentTokenMiningReward()
   {
     ...
     var reward_amount =  new Promise(function (fulfilled,error) {
      console.log("Requesting current minerreward",reward_amount)
