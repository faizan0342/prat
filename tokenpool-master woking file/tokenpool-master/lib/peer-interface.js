...
module.exports =  {
   ...
   */
   async handlePeerShareSubmit(nonce,minerEthAddress,challengeNumber,digest,difficulty,customVardiff)
   {
     ...
     */
     ...
     console.log("Something related to vardiff ")
  ...
  async getAverageSolutionTime(minerAddress)
  {
   ...
   async getUpdatedVarDiffForMiner(sharesData,minerAddress)
   {
      ...
      console.log("Assuming something related to block generate or tansaction which is 60 seconds")
   ...
   async monitorMinedSolutions()
   {
    ...
    console.log('error',e)
      ...
      console.log("This is something related to monitor mined solution ")
